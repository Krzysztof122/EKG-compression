...
\begin{tabular}{ccc}
\toprule
\textbf{Wymiar ukryty (\texttt{latent\_dim})} & \textbf{Stopień kompresji} & \textbf{Średni błąd MSE (Test Loss)} \\ \midrule
4   & 46.75$\times$ & 0.012066 \\
8   & 23.38$\times$ & 0.006891 \\
12  & 15.58$\times$ & 0.006198 \\
16  & 11.69$\times$ & 0.006442 \\
24  & 7.79$\times$  & 0.004534 \\
32  & 5.84$\times$  & 0.002555 \\
40  & 4.67$\times$  & 0.001928 \\
48  & 3.90$\times$  & 0.002344 \\
64  & 2.92$\times$  & 0.001327 \\
96  & 1.95$\times$  & 0.001428 \\
128 & 1.46$\times$  & 0.000548 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../plots/mse_results_graph.png} 
